...
public class Graphic extends JFrame{
	...
	private void init(){
        ...
        //from here
		_x = Toolkit.getDefaultToolkit().getScreenSize().width;
		_y = Toolkit.getDefaultToolkit().getScreenSize().height;
		int vindexN3 = isSupported(_x, _y, 32, dms);

        //get manually
        //int vindexN3 = isSupported(1200, 720, 32, dms);
        //to here
